...
public class GameStoreInvoiceServiceLayer {
    ...
    private GameStoreCatalogFeignClient clientConsole;
    private GameStoreCatalogFeignClient clientGame;
    private GameStoreCatalogFeignClient clientTShirt;
    ...
    @Autowired
    public GameStoreInvoiceServiceLayer(GameStoreCatalogFeignClient clientConsole, GameStoreCatalogFeignClient clientGame, GameStoreCatalogFeignClient clientTShirt,
                                        InvoiceRepository invoiceRepo, TaxRepository taxRepo, ProcessingFeeRepository processingFeeRepo) {
        this.clientConsole = clientConsole;
        this.clientGame = clientGame;
        this.clientTShirt = clientTShirt;
    ...
    public InvoiceViewModel createInvoice(InvoiceViewModel invoiceViewModel) {
        ...
        if (invoiceViewModel.getItemType().equals(CONSOLE_ITEM_TYPE)) {
            ...
            Optional<Console> returnVal = Optional.ofNullable(clientConsole.getConsole(invoiceViewModel.getItemId()));
            ...
            Game tempGame = null;
            Optional<Game> returnVal = Optional.ofNullable(clientGame.getGameInfo(invoiceViewModel.getItemId()));
            ...
            Optional<TShirt> returnVal = Optional.ofNullable(clientTShirt.getTShirt(invoiceViewModel.getItemId()));
